####### Syed Kashif Ejaz
####### https://github.com/KashifzGit
####### Special Thanks to Matt Hansen https://github.com/matthansen0 who wrote the initial version
####### Last Updated September 23, 2025
####### This script will export and compress all Hyper-V VMs to a defined folder
#Variables
$date = Get-Date -Format "MM-dd-yyyy"
$base = "C:\backup\backup"
